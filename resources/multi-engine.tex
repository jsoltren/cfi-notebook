...
\textit{\textbf{Note:}}                                             & \textit{See Appendix 2: Safety of Flight and Appendix 3: Aircraft, Equipment, and Operational Requirements \& Limitations for information related to this Task.}                                                                         \\ \hline
\textbf{Knowledge:}                                                 & The applicant demonstrates understanding of:                                                                                                                                                                                             \\
\textit{CA.X.B.K1}                                                  & Factors affecting VMC and how VMC differs from stall speed (VS).                                                                                                                                                                         \\
\textit{CA.X.B.K2}                                                  & VMC (red line), VYSE (blue line), and safe single-engine speed (VSSE).                                                                                                                                                                   \\
...
\textbf{Skills:}                                                    & The applicant exhibits the skill to:                                                                                                                                                                                                     \\
\textit{CA.X.B.S1}                                                  & Configure the airplane in accordance with the manufacturer’s recommendations, in the absence of the manufacturer’s recommendations, then at safe single-engine speed (VSSE/VYSE), as appropriate, and:                                   \\
...
\textit{CA.X.B.S2}                                                  & Establish a single-engine climb attitude with the airspeed at approximately 10 knots above VSSE.                                                                                                                                         \\
...
\textit{CA.X.B.S8}                                                  & Advance power smoothly on the operating engine and accelerate to VSSE/VYSE, as appropriate, ±5 knots during recovery.                                                                                                                   
\end{tabular}
\end{table}
