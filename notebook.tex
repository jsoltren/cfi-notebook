...
{\Large\textsc{jos\'e hiram soltren \\ cfi cfii mei aigi}} % Author name, lower case for consistent small caps
...
\part{Private and Commercial Operations}

\input{resources/federal-aviation-regulations.tex}

\input{resources/performance-limitations.tex}

\input{resources/emergency-procedures.tex}

\input{resources/weather.tex}

\input{resources/aeromedical-factors.tex}

\input{resources/high-altitude.tex}

\input{resources/commercial-pilot.tex}

\input{resources/commercial-checkride.tex}

\part{Multi Engine Operations}

\input{resources/multi-engine.tex}

\part{Appendix}

\input{resources/alphabet-soup.tex}
